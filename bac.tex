...
{
  name={agent figure},
  description={Also virtual agentfigure or virtual figure. Refers to the agent-controlled figure on the screen}
}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{\Glspl{visitor} with their assigned skeletons drawn onto them.}
